...
export const sendPasswordResetEmail = async (email: string, url: string) => {
  await sendEmail({
    to: email,
    subject: 'Reset Your SaasHQ Password',
    html: `
        Dear User,
        <br/><br/>
        We have received a request to reset your SaasHQ password. If you did not request a password reset, please ignore this email.
        <br/><br/>
